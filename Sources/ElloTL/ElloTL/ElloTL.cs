...
public partial class ElloTL {
    ...
    private static string[] validIdentifiers = new string[] { "p", "i", "b", "u", "em", "hr", "img" };
    ...
    private async Task Process(INode node, State state, bool inParagraph = false) {
        if (node.NodeType == NodeType.Element) {
            ...
            if (identifier != "hr" && identifier != "img" && el.TextContent.Trim() == string.Empty && el.QuerySelector("img") == null) return;
