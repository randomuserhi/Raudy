...
public partial class IndraTranslations {
    private const string domain = "indratranslations.com";
            ...
            using (HttpResponseMessage res = await client.SendAsync(request)) {
                if (res.IsSuccessStatusCode) {
                    using (HttpContent content = res.Content) {
                        ...
                        IElement? title = document.QuerySelector(".reading-content.current>chapter-name");
                        if (title != null) {
                        ...
                        IElement body = document.QuerySelector(".reading-content.current")!;
