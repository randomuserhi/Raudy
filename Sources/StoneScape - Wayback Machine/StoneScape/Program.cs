...
namespace Source {
    internal class Program {
        static int Main(string[] args) {
            Task.Run(async void () => {
                StoneScape stone = new StoneScape();
                ...
                string waybackprefix = "https://web.archive.org/web/20250308063755/";
                ...
                for (int i = 0; i < urls.Length; ++i) {
                    ...
                    if (i >= skip) {
                        await stone.DownloadChapter($"{waybackprefix}{url}", @"D:\Visual Novels\[Self-Sourced] [Missing ch164 onwards (novelpia)] Villainess Gardian Knight\Raw\" + $"Volume {volume}", $"{chapter.ToString("D4")}.xhtml");
                    }
